...
static function JsonObject Deserialize(string JsonString)
{
	return static.DeserializeIntoExistingObject(new class'JsonObject', JsonString);
}

static function JsonObject DeserializeIntoExistingObject(JsonObject Json, string JsonString)
{
...
static function string ExtractNextName(string JsonString, out int ProcessedLength)
{
...
static function string UnescapeChar(string EscapedChar)
{
	if(EscapedChar == "n")
		return Chr(10);
	if(EscapedChar == "r")
...
static function string UnescapeUnicode(string HexDigits)
{
	local int CharCode;
...
static function string ExtractNextValue(string JsonString, out int ProcessedLength)
{
...
static function array<string> ProcessStringAsArray(string JsonString, out int ProcessedLength)
{
...
static final function StoreInArray(out array<string> TargetArray, string ValueToStore)
{
	local int NewValueEntry;

	NewValueEntry = TargetArray.Length;
	TargetArray.Length = NewValueEntry+1;
	TargetArray[NewValueEntry] = ValueToStore;
}
